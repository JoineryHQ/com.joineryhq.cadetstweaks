 ...
 */
class CRM_Cadetstweaks_Upgrader_Base {

  /**
   * @var CRM_Cadetstweaks_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Cadetstweaks_Upgrader(
        'com.joineryhq.cadetstweaks',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Cadetstweaks_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Cadetstweaks_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
